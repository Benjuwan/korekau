            ...
            <section>
                ...
                <dl className="lg:flex lg:flex-row lg:flex-wrap lg:gap-[5%]">
                    <div className="mb-[5em] lg:w-[47.5%]">
                        <dt className="text-[1.5rem]"><h4 className="text-[#f0b20e] border-l-[#f0b20e] border-l-4 pl-[.5em] mb-[.5em]">1. 買うものリスト</h4></dt>
                        <dd>
                    ...
                    <div className="mb-[5em] lg:w-[47.5%]">
                        <dt className="text-[1.5rem]"><h4 className="text-[#f0b20e] border-l-[#f0b20e] border-l-4 pl-[.5em] mb-[.5em]">2. 商品価格の比較</h4></dt>
                        <dd>
                            <div className="bg-[#f5f5f5] rounded p-[1em] mb-[2.5em]">
                    ...
                    <div className="mb-[5em] lg:w-[47.5%]">
                        <dt className="text-[1.5rem]"><h4 className="text-[#f0b20e] border-l-[#f0b20e] border-l-4 pl-[.5em] mb-[.5em]">3. カレンダー</h4></dt>
                        <dd>
                            <div className="bg-[#f5f5f5] rounded p-[1em] mb-[2.5em]">
                    ...
                    <div className="mb-[5em] lg:flex lg:flex-row lg:flex-wrap lg:gap-[5%] lg:w-[47.5%]">
                        <dt className="text-[1.5rem]"><h4 className="text-[#f0b20e] border-l-[#f0b20e] border-l-4 pl-[.5em] mb-[.5em]">4. ゴミ出し日</h4></dt>
                        <dd>
                            <div className="bg-[#f5f5f5] rounded p-[1em] mb-[2.5em]">
