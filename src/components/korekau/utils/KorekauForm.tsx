...
export const KorekauForm = memo(({ KorekauItemList }: { KorekauItemList?: korekauItemsType }) => {
    ...
    return (
        <form action="" className="w-full h-fit rounded p-[1.5em] shadow-[0_0_8px_rgba(160,160,160,.5)_inset] my-[1em] mx-auto bg-white overflow-y-auto" onSubmit={handleFormSubmit}>
