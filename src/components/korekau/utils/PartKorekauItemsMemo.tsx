...
export const PartKorekauItemsMemo = memo(({ korekauList }: { korekauList: korekauItemsType }) => {
    ...
    return (
        <div className="korekauMemo my-[.5em] w-full">
            ...
            <div className="korekauMemoContenet absolute top-0 left-[50%] z-[-1] transform-[translate(-50%,5em)] w-full h-fit max-h-60 rounded-[.5rem] overflow-y-scroll p-4 text-white bg-[rgba(80,80,80,.85)] opacity-[0] invisible transition duration-[.25s]">
