                ...
                {todoItem.edit ?
                    <>
                        ...
                        <div className="cursor-default flex gap-[1em] w-full mt-[2.5em] mx-0 mb-[1em]">
                            <button id="deleteBtn" className="cursor-pointer aspect-square rounded-lg w-full border border-transparent h-[2.75rem] grid place-content-center m-auto rounded-lg tracking-[.25em] bg-[#cc3226] text-white hover:bg-white hover:text-[#cc3226] hover:border-[#cc3226] active:bg-white active:text-[#cc3226] active:border-[#cc3226]" type="button" onClick={(deleteBtn: SyntheticEvent<HTMLButtonElement>) => {
                                handleCloseModalWindowBtnClicked(deleteBtn);
                                deleteTodoItem(todoItem.uuid);
                            }}>削除</button>
                            <button className="cursor-pointer aspect-square rounded-lg w-full border border-transparent h-[2.75rem] grid place-content-center m-auto rounded-lg tracking-[.25em] bg-[#59b835] text-white hover:bg-white hover:text-[#59b835] hover:border-[#59b835] active:bg-white active:text-[#59b835] active:border-[#59b835]" type="button" onClick={() => changeMode(todoItem)}>戻る</button>
                        </div>
                    </> :
